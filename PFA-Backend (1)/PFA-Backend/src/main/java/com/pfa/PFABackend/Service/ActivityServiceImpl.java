...
public class ActivityServiceImpl implements ActivityService{
    ...
    public void validateUserPermission(User currentUser) {
        boolean isCommissionMember = currentUser.getRole().stream()
                .anyMatch(role -> role.getName().equals("COMMISSION"));
        if (!isCommissionMember) {
            throw new IllegalArgumentException("Vous n'avez pas la permission de valider cette activité");
        }
    }
