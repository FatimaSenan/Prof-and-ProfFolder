...
public class ActivityServiceImpl implements ActivityService{
    ...
    public List<List<?>> getActivitiesByProfessorId(int professorId) {
        User user = userRepository.findById(professorId).orElseThrow(() -> new RuntimeException("Professor not found"));
        return getActivitiesByUser(user);
    }

    private List<List<?>> getActivitiesByUser(User user) {
        List<List<?>> activities = new ArrayList<>();
        activities.add(chefDépartementRepository.findByUser(user));
        activities.add(coordonateurFilièreRepository.findByUser(user));
        activities.add(coordonateurModuleRepository.findByUser(user));
        activities.add(didacticielsRepository.findByUser(user));
        activities.add(encadrementPFERepository.findByUser(user));
        activities.add(encadrementRHRepository.findByUser(user));
        activities.add(manuelRepository.findByUser(user));
        activities.add(membreCommissionAdHocRepository.findByUser(user));
        activities.add(membreCommissionConseilRepository.findByUser(user));
        activities.add(membreCommisionEtablissementRepository.findByUser(user));
        activities.add(membreConseilCoordinationRepository.findByUser(user));
        activities.add(membreEluConseilRepository.findByUser(user));
        activities.add(montagesExpérimentauxRepository.findByUser(user));
        activities.add(moocRepository.findByUser(user));
        activities.add(ouvrageRepository.findByUser(user));
        activities.add(pageWebRepository.findByUser(user));
        activities.add(petitsLivresRepository.findByUser(user));
        activities.add(polycopiésPédagogiquesRepository.findByUser(user));
        activities.add(préparationSortiesTerrainRepository.findByUser(user));
        activities.add(rapportStageVisiteTerrainRepository.findByUser(user));
        activities.add(supportsRepository.findByUser(user));
        activities.add(viceDoyenRepository.findByUser(user));
        activities.add(associationConnaissanceRepository.findByUser(user));
        activities.add(brevetRepository.findByUser(user));
        activities.add(chapitreOuvrageRepository.findByUser(user));
        activities.add(congrèsConférencesNonPubliéesRepository.findByUser(user));
        activities.add(congrèsConférencesPubliéesRepository.findByUser(user));
        activities.add(contributionOrganisationActivitésRayonnementRepository.findByUser(user));
        activities.add(créationStartUpRepository.findByUser(user));
        activities.add(doctoratsEncadrésRepository.findByUser(user));
        activities.add(editeurMembreRéféréJournalRevueRepository.findByUser(user));
        activities.add(encadrementMémoiresMasterRepository.findByUser(user));
        activities.add(expertiseNonRémunéréRepository.findByUser(user));
        activities.add(incubationProjetRechercheRepository.findByUser(user));
        activities.add(ouvrageSpecialiséRepository.findByUser(user));
        activities.add(participationthèseDoctoratRepository.findByUser(user));
        activities.add(projetsContratsRechercheRepository.findByUser(user));
        activities.add(publicationRevuesScientifiquesRepository.findByUser(user));
        activities.add(publicationsRevuesIndexéesRepository.findByUser(user));
        activities.add(responsableMembreStructureRechercheAccréditéePoleCompetenceRepository.findByUser(user));
